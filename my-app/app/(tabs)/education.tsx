...
const styles = StyleSheet.create({
  ...
  heading: {
    fontSize: 20, fontWeight: 'bold', color: PortfolioColors.primary,
    marginBottom: 25, borderBottomWidth: 2, borderBottomColor: '#e9ecef',
    paddingBottom: 5, letterSpacing: 1, textTransform: 'uppercase'
  },
  card: {
    flexDirection: 'row', marginBottom: 25, backgroundColor: '#f8f9fa',
    padding: 15, borderRadius: 10, alignItems: 'flex-start',
  },
  icon: { marginRight: 15, marginTop: 2 },
  textContainer: { flex: 1 },
  subHeading: { fontSize: 16, fontWeight: 'bold', color: PortfolioColors.textDark, marginBottom: 4 },
